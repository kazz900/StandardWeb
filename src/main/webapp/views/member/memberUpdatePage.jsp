...
<body>
 ...
 %>
			...
			<tr>
				<th>나이</th>
				<td><input type="number" name="age" min="19"
			...
			<tr>
				<th>기타 정보(연습용)</th>
				<td><textarea name="etc" rows="3" cols="50"></textarea></td>
			</tr>
			<tr>
				<th colspan="2"><input type="submit" value="수정하기">
					&nbsp; <a href="/first/mdel?userid=<%= member.getUserId() %>">탈퇴하기</a>
					<a href="javascript:history.go(-1);">이전 페이지로 이동</a> &nbsp;<!-- javascript:history.go()전페이지로 이동 -->
